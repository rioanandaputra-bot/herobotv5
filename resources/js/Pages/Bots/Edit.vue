...
const form = useForm({
    ...
    prompt: props.bot.prompt || predefinedPrompts.customer_service,
    ai_chat_service: props.bot.ai_chat_service || '',
    ai_embedding_service: props.bot.ai_embedding_service || '',
    ai_speech_to_text_service: props.bot.ai_speech_to_text_service || '',
    openai_api_key: props.bot.openai_api_key || '',
    gemini_api_key: props.bot.gemini_api_key || '',
});
